...
#        return self.physObj.p4(self.physObj.candidateP4Kind()) # if kind == None else kind)
    ...
    def LooseNoIsoID(self):
        ...
        if not ( self.physObj.isEB() or self.physObj.isEE() ): 
            LooseNoIso = 0

        if ( self.f_full5x5sigmaIEtaIEta()   >= ( 0.11    if self.physObj.isEB() else 0.0314) ): 
            LooseNoIso = 0

        if ( self.f_dEtaInSeed()             >= ( 0.00477 if self.physObj.isEB() else 0.00868) ): 
            LooseNoIso = 0

        if ( self.f_dPhiSCTrackatVtx()       >= ( 0.222   if self.physObj.isEB() else 0.213) ):
            LooseNoIso = 0

        if ( self.f_hadronicOverEM()         >= ( 0.298   if self.physObj.isEB() else 0.101) ):
            LooseNoIso = 0

        if ( self.f_InvEminusInvP()          >= ( 0.241   if self.physObj.isEB() else 0.14) ): 
            LooseNoIso = 0
    ...
    def MediumNoIsoID(self):
        ...
        if ( self.f_full5x5sigmaIEtaIEta()   >= ( 0.00998 if self.physObj.isEB() else 0.0298) ):
            MediumNoIso = 0

        if ( self.f_dEtaInSeed()             >= ( 0.00311 if self.physObj.isEB() else 0.00609) ):
            MediumNoIso = 0

        if ( self.f_dPhiSCTrackatVtx()       >= ( 0.103   if self.physObj.isEB() else 0.045) ):
            MediumNoIso = 0

        if ( self.f_hadronicOverEM()         >= ( 0.253   if self.physObj.isEB() else 0.0878) ):
            MediumNoIso = 0

        if ( self.f_InvEminusInvP()          >= ( 0.134   if self.physObj.isEB() else 0.13) ):
            MediumNoIso = 0
    ...
    def MediumWithIsoID(self):
        ...
        if ( self.f_full5x5sigmaIEtaIEta()   >= ( 0.00998 if self.physObj.isEB() else 0.0292 ) ):
            TightIso = 0

        if ( self.f_dEtaInSeed()             >= ( 0.00308 if self.physObj.isEB() else 0.00605) ):
            TightIso = 0

        if ( self.f_dPhiSCTrackatVtx()       >= ( 0.0816   if self.physObj.isEB() else 0.0394) ):
            TightIso = 0

        if ( self.f_hadronicOverEM()         >= ( 0.0414   if self.physObj.isEB() else 0.0641) ):
            TightIso = 0

        if ( self.f_InvEminusInvP()          >= ( 0.0129   if self.physObj.isEB() else 0.0129) ):
            TightIso = 0      
